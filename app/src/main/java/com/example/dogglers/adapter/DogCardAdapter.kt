...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        when(layout){
            // if the layout is vertical or horizontal
            1, 2 -> {
                val verticalHorizontalAdapterLayout = LayoutInflater.from(parent.context)
                    .inflate(R.layout.vertical_horizontal_list_item, parent, false)

                adapterLayout = verticalHorizontalAdapterLayout
            }
            // if the layout is grid
            3 -> {
                val gridAdapterLayout = LayoutInflater.from(parent.context)
                    .inflate(R.layout.grid_list_item, parent, false)

                adapterLayout = gridAdapterLayout
            }
        }
